...
<div class="w" id="regist">
    <div class="mt">
        ...
        <span style="text-align: right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="flk13"
                ...
                href="http://www.kubuy.com/user/login.html"
                    ...
                    <div id="mobileCodeDiv" class="item hide" style="height: 62px;">
                        ...
                        <div class="fl item-ifo">
                            <input type="text" maxlength="6" autocomplete="off" tabindex="6" class="text text-1"
                                   name="mobileCode"
                                   style="ime-mode:disabled" id="mobileCode" onblur="checkCode()"
                                   onfocus="mobileCodeFocus();">
                            <label class="blank invisible"></label>
                            <a class="btn" href="javascript:void(0);" onclick="getCapycode();" id="sendMobileCode">
    ...
    function getCapycode() {
    	var telephone=$("#phone").val();
    	$.ajax({
    		url : "http://www.kubuy.com/service/user/"+telephone+"?r=" + Math.random(),
    		dataType : "jsonp",
    ...
    function checkCode() {
    	...
    	$.ajax({
    		url : "http://www.kubuy.com/service/user/code/"+Code+"?r=" + Math.random(),
    		dataType : "jsonp",
    		success : function(data) {}
    	    });
    }
