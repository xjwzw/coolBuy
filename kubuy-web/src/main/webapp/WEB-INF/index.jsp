...
<section id="pc-advert">
    <div class="container-c clearfix">
        <a href="${app}/item/detail/1.html" ><img src="theme/img/pd/pd1.png"></a>
        <a href="${app}/item/detail/1.html" ><img src="theme/img/pd/pd2.png"></a>
        <a href="${app}/item/detail/1.html" ><img src="theme/img/pd/pd3.png"></a>
        <a href="${app}/item/detail/1.html" ><img src="theme/img/pd/pd4.png"></a>
    </div>
</section>
<!-- advert End -->
            ...
            <div class="yScrollList">
                <div class="yScrollListIn">
                    <div style="display:block;" class="yScrollListInList yScrollListInList1">
                        <ul>
                            <li>
                                <a href="http://www.kubuy.com//items/536563.html">
                                    <img src="theme/img/pd/p1.png">
