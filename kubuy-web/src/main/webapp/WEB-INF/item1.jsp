...
<html>
 <head>
	...
	<script type="text/javascript" src="${app }/theme/js/index.js"></script>
	<script type="text/javascript" src="${app }/theme/js/js-tab.js"></script>
    <script>
         $(function(){
            ...
            <div class="pc-details-l">
                <div class="pc-product clearfix">
                    <div class="pc-product-h">
                        <div class="pc-product-top"><img src="${item.images[0] }" id="big_img" width="418" height="418"></div>
                        <div class="pc-product-bop clearfix" id="pro_detail">
                            <ul>
                                <li><a href="javascript:void(0);" class="cur" simg="${item.images[1] }"><img src="${item.images[1] }" width="58" height="58"></a> </li>
                                <li><a href="javascript:void(0);" simg="${item.images[2] }"><img src="${item.images[2] }" width="58" height="58"></a> </li>
                                <li><a href="javascript:void(0);" simg="${item.images[3] }"><img src="${item.images[3] }" width="58" height="58"></a> </li>
                                <li><a href="javascript:void(0);" simg="${item.images[4] }"><img src="${item.images[4] }" width="58" height="58"></a> </li>
                                <li><a href="javascript:void(0);" simg="${item.images[5] }"><img src="${item.images[5] }" width="58" height="58"></a> </li>
                            </ul>
                        </div>
                    </div>
                    <div class="pc-product-t">
                        <div class="pc-name-info">
                            <h1>${item.title } </h1>
                            <p class="clearfix pc-rate"><strong>￥${item.price/100 }</strong></p>
                            <p>由<a href="#" class="reds">酷购商城</a> 负责发货，并提供售后服务。</p>
                        </div>
                        ...
                        <div class="pc-size">
                            ...
                            <div class="pc-telling clearfix">
                                ...
                                <div class="pc-adults">
                                    <ul>
                                        <li><a href="#" title="黑色" class="cur"><img src="${app }/theme/img/pd/product.png" width="35" height="35"></a> </li>
                                        <li><a href="#" title="白色"><img src="${app }/theme/img/pd/product1.png" width="35" height="35"></a> </li>
                                        <li><a href="#" title="金色"><img src="${app }/theme/img/pd/product2.png" width="35" height="35"></a> </li>
                            ...
                            <div class="pc-number clearfix"><span class="fl">商品编号：${item.id }   </span> <span class="fr">分享 收藏</span></div>
                        </div>
                        <div class="pc-emption">
                            <a href="#">立即购买</a>
                            <a href="${app }/service/cart/add/${item.id }" class="join">加入购物车</a>
                        </div>
                    </div>
