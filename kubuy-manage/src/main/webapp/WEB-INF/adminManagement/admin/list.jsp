	...
	$.ajax({
		...
		success:function(data){
			...
			for(var i=0;i<data.length;i++){
				...
				tr+="<td><input type='checkbox' value='"+data[i].adminId+"' name=''></td>";
				tr+="<td>"+data[i].adminId+"</td>";
				tr+="<td><u style='cursor:pointer' class='text-primary'>"+data[i].username+"</u></td>";
				tr+="<td>"+data[i].info.gender+"</td>";
				tr+="<td>"+data[i].info.phoneNo+"</td>";
				tr+="<td>"+data[i].info.email+"</td>";
				tr+="<td class='td-status'><span class='label label-success radius'>"+(data[i].state==null?"待填写":data[i].state)+"</span></td>";
				tr+="<td class='td-status'><span class='label label-success radius'>"+data[i].status+"</span></td>";
				...
				tr += "<td>"+data[i].station+"</td>";
				tr += "<td>"+data[i].atTime+"</td>";
