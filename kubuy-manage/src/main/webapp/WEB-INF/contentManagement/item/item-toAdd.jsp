...
<link href="${app }/staticfile/lib/webuploader/0.1.5/webuploader.css" rel="stylesheet" type="text/css" />
<title>商品新增</title>
</head>
<body>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<div class="uploader-thum-container">
					...
					<a href="javascript:;" onclick="item_add('选择分类','${app}/contentManagement/cat/listforitem','400','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 选择分类</a>
				</div>
			</div>
		</div>
...
<script type="text/javascript" src="${app }/staticfile/lib/webuploader/0.1.5/webuploader.min.js"></script> 
<script type="text/javascript" src="${app }/staticfile/lib/ueditor/1.4.3/ueditor.config.js"></script>
<script type="text/javascript" src="${app }/staticfile/lib/ueditor/1.4.3/ueditor.all.min.js"> </script>
<script type="text/javascript" src="${app }/staticfile/lib/ueditor/1.4.3/lang/zh-cn/zh-cn.js"></script>
